...
public:
  ...
  void SetUp() {
    ...
    background_service_manager_->RegisterService(
      service_manager::Identity("executable_client_with_res", //!!! register itself !!!
...
int main(int argc, char **argv) {
  ...
  base::TaskScheduler::CreateAndStartWithDefaultParams("executable_client_with_resource");
  ...
  logger->Log("test logger with resource");
